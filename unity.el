...
(defun unity3d-dired-open-marked-files ()
  ...
  (dired-shell-command (concat "start chrome \"" file "\""))))
...
(defvar unity3d-mode-map
  ...
  (define-key map (kbd "<C-M-backspace>") 'unity3d-find-doc)
...
(define-minor-mode unity3d-mode
  "Toggle Frostbite mode.
Frostbite mode allows a bunch of Frostbite related useful commands and search functions..."
  :init-value nil
  :global nil
  :lighter " unity3d"
